...
LG    = computeL_randomwalk(x_TV, sigmaInt, R);
...
LG    = computeL_randomwalk(x_Tik, sigmaInt, R);
...
LG   = computeL_randomwalk(x_NN, sigmaInt, R);
...
% Build Graph Laplacian
LG   = computeL_randomwalk(x_FBP, sigmaInt, R);
