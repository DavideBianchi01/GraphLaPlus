...
for k = 1:noise_level_n
    ...
    LG    = computeL_randomwalk(xx_TV, sigmaInt, R);
...
for k = 1:noise_level_n
    ...
    LG    = computeL_randomwalk(xx_Tik, sigmaInt, R);
...
for k = 1:noise_level_n
    ...
    LG   = computeL_randomwalk(xx_NN, sigmaInt, R);
    ...
    LG   = computeL_randomwalk(xx_FBP, sigmaInt, R);
...
for k = 1:noise_level_n
    ...
    % Build Graph Laplacian
    LG   = computeL_randomwalk(x_true, sigmaInt, R);
